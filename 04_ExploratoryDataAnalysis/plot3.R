#This script includes the code to create plot3.png of assignment1
...
## 3. Plot according to Plot3 example in assignment and save histogramm as png with 480 pixels as width and height
y1 <- data$Sub_metering_1;
y2 <- data$Sub_metering_2;
y3 <- data$Sub_metering_3;

png(filename = "plot3.png",width = 480, height = 480);
par(ps = 11, cex = 1, cex.main = 1); #setting the font size accordingly
...
legend("topright", lty = 1,col = c("black", "red", "blue"), legend = c("Sub_metering_1", "Sub_metering_2", "Sub_metering_3"), y.intersp = 0.8,x.intersp=1,seg.len = 1.75, adj = 0,cex = 1);
